...
const contactInfo = [
  ...
  },
  {
    ...
    subContent: '7/24 yazabilirsiniz',
        ...
        <div className="container-wide relative">
          ...
          >
            ...
            <p className="mt-6 text-lg text-[var(--color-foreground-secondary)] leading-relaxed">
              Rezervasyon, özel etkinlikler veya sorularınız için bize ulaşabilirsiniz. 
              ...
              >
                ...
                <div className="relative">
                  ...
                  <div className="mt-6 flex items-center gap-1 text-sm text-[var(--color-accent)] opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <span>{item.external ? 'Yönlendir' : 'Bağlan'}</span>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-[var(--color-foreground-secondary)] mt-1">
                        Google Maps üzerinden navigasyon başlat
                      </p>
                    </div>
              ...
              <div className={cn(
                ...
                <div className="mt-8 p-4 rounded-xl bg-[var(--color-background-secondary)]">
                  <p className="text-sm text-[var(--color-foreground-secondary)] text-center">
                    <span className="text-[var(--color-accent)] font-medium">Not:</span> Özel etkinlikler ve grup rezervasyonları için farklı saatler uygulanabilir.
                  </p>
                </div>
              </div>
            </motion.div>
          ...
          >
            ...
            <div className="relative text-center max-w-2xl mx-auto">
              ...
              <p className="text-lg text-[var(--color-stone-300)] mb-8">
                En iyi deneyim için rezervasyon yaptırmanızı öneririz. 
                WhatsApp üzerinden hızlıca yer ayırtabilirsiniz.
              </p>
